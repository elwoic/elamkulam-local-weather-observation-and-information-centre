...
// CONFIGURATION
// ---------------------------
const openWeatherApiKey = "ca13a2cbdc07e7613b6af82cff262295"; // Your OpenWeatherMap API key
const latitude = 10.9081;     // Elamkulam latitude
const longitude = 76.2296;    // Elamkulam longitude

// Open-Meteo URL (must be inside quotes + template string)
const openMeteoUrl =
  `https://api.open-meteo.com/v1/forecast?latitude=${latitude}&longitude=${longitude}&hourly=temperature_2m,humidity_2m,windspeed_10m&current_weather=true&timezone=Asia/Kolkata`;
...
async function loadWeatherSnapshot() {
  try {
    ...
    document.getElementById("om-temp").textContent = omTemp;
    document.getElementById("om-wind").textContent = omWind;
