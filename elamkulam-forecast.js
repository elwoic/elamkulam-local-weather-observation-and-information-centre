...
function generateLongNewsMalayalam({ computed, owmData, airQuality, imdAlert }) {
  ...
  s.push(
    "💡 **പൊതുജന നിർദ്ദേശം:**\nഉച്ച സമയങ്ങളിൽ നേരിട്ട് സൂര്യപ്രകാശം ഏറ്റുവാങ്ങുന്ന പ്രവർത്തനങ്ങൾ ഒഴിവാക്കുക. ധാരാളം വെള്ളം കുടിക്കുക. രാവിലെ അല്ലെങ്കിൽ വൈകുന്നേരം ചെറിയ നടക്കൽ ശരീരത്തിന് ഗുണകരമായിരിക്കും."
  );
  ...
  if (imdAlert && imdAlert.text) {
    s.push(
      `⚠️ **ഔദ്യോഗിക മുന്നറിയിപ്പ്:**\nകേന്ദ്ര കാലാവസ്ഥാ വകുപ്പിന്റെ ഏറ്റവും പുതിയ അറിയിപ്പ് പ്രകാരം പ്രദേശത്ത് ${imdAlertMalayalamMeaning(
