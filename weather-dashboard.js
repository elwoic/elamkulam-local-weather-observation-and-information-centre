...
/* --- Marquee 2: Forecast / Rain Chances --- */
...
async function fetchWeather() {
    try {
        ...
        if (data && data.list && data.list.length > 0) {
            ...
            document.getElementById("weather-table-body").innerHTML = "<tr><td colspan='5'>Failed to load data.</td></tr>";
        }
    } catch (e) {
        console.error(e);
        document.getElementById("weather-table-body").innerHTML = "<tr><td colspan='5'>Error loading weather data.</td></tr>";
    }
}
...
async function loadWeatherDetails() {
    try {
        ...
        console.error(error);
        document.getElementById("extraWeather").innerHTML = `<p style="color:red;text-align:center;">Failed to load extra details.</p>`;
    }
}
